...
\teaser{
  ...
  \caption{Experience the magic of interactive proof trees${^{TMLOL}}$}
	\label{fig:teaser}
}
...
Before further discussion of the visualization tool, we will take a step back to review the logic concepts needed to understand how to use it in Section~\ref{sec:background}. Next in Section~\ref{sec:tooldesc}, the tool and expected user tasks will be described. Following an initial discussion of the tool and how to use it, we discuss the technologies used to implement it in Section~\ref{sec:technology}. InfoVis results motivating the design of the tool will be explored in the Section~\ref{sec:infoviselem}. Finally, in the remaining sections we discuss limitations and deeper topics related to the tool, future work, and finish with a conclusion reviewing what is presented here. We hope the reader will be left with an understanding of the motivation for and use of \projectname{} and know how InfoVis techniques implemented here help users to learn about specific proofs and proof systems.

TODO: update at end! in case sections have changed
...
TODO: more description of structure of proof trees used by math and logic community? in design section \\


TODO:

\begin{itemize}
\item present how design came about
\item discuss knowledge and observations about likely users
\item discuss use cases that are important and explain why
\item rationale for design choices
\item early prototypes and sketches
\end{itemize}
...
TODO: add discussion of how things could be fixed
...
In the future we hope to perform a more detailed evaluation following the cognitive dimensions of Blackwell and Green (TODO: ref).
