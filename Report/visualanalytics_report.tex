...
Other updates would add more uses for the tool that are (aside,...iary) to information visualization. Once a proof is built, the user may want to use it in a \LaTeX{} document. It would be a small change to export the \LaTeX{} code for the tree from the JSON object representing the tree.
